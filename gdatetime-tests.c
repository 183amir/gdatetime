...
static void
test_GCalendarGregorian_get_day_of_week (void)
{
  GCalendar *cal;
  GDateTime *dt;
  ...
  dt = g_date_time_new_full (2009, 10, 25, 13, 14, 15);
  cal = g_calendar_gregorian_new ();
  g_assert_cmpint (7, ==, g_calendar_get_day_of_week (cal, dt));
  g_date_time_unref (dt);
  g_object_unref (cal);
}
      ...
      gchar *argv[])
{
  ...
  */
  ...
  g_test_add_func ("/GCalendarGregorian/get_day_of_week",
                   test_GCalendarGregorian_get_day_of_week);
